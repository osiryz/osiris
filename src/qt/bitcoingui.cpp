...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About osiris"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/bitcoin"), tr("Show/Hide &osiris"), this);
    toggleHideAction->setToolTip(tr("Show or hide the osiris window"));
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide osiris"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(STATUSOSR_ICONSIZE,STATUSOSR_ICONSIZE));
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if(secs < 90*60 && count >= nTotalBlocks)
    {
        ...
        labelBlocksIcon->setPixmap(QIcon(":/icons/synced").pixmap(STATUSOSR_ICONSIZE, STATUSOSR_ICONSIZE));
...
void BitcoinGUI::setMining(bool mining, int hashrate)
{
    if (mining)
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_active").pixmap(STATUSOSR_ICONSIZE,STATUSOSR_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Mining osiris at %1 hashes per second").arg(hashrate));
    }
    else
    {
        labelMiningIcon->setPixmap(QIcon(":/icons/mining_inactive").pixmap(STATUSOSR_ICONSIZE,STATUSOSR_ICONSIZE));
        labelMiningIcon->setToolTip(tr("Not mining osiris"));
    }
}
...
void BitcoinGUI::setEncryptionStatus(int status)
{
    ...
    case WalletModel::Unlocked:
        ...
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_open").pixmap(STATUSOSR_ICONSIZE,STATUSOSR_ICONSIZE));
    ...
    case WalletModel::Locked:
        labelEncryptionIcon->show();
        labelEncryptionIcon->setPixmap(QIcon(":/icons/lock_closed").pixmap(STATUSOSR_ICONSIZE,STATUSOSR_ICONSIZE));
